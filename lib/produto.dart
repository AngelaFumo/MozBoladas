// lib/boladas/adicionar_produto.dart
...
class _AdicionarProdutoScreenState extends State<AdicionarProdutoScreen> {
  ...
  void _postarProduto() {
    if (_formKey.currentState!.validate()) {
      ...
      print('Produto Adicionado: $nome, Preço: $preco, Tamanho: $tamanho, Imagem: $_imagePath');
  ...
  void _selecionarImagem() {
    // Aqui você pode abrir galeria ou câmera
    // Por enquanto, apenas simula a seleção de imagem
    setState(() {
